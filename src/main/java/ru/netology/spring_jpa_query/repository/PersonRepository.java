...
//    List<Person> findByCity(@Param("city") String city, Sort sort);
...
//    List<Person> findByComposeIdAgeLessThan(@Param("age") int age);
    ...
    @Query("select p from Person p where p.composeId.age < :age")
    List<Person> findByComposeIdAgeLessThan(@Param("age") int age, Sort sort);
